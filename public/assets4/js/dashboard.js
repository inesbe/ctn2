  ...
  $(function() {
    ...
    if ($("#visit-sale-chart").length) {
      ...
      var gradientLegendRed = 'linear-gradient(to right, rgba(255, 191, 150, 1), rgba(254, 112, 150, 1))';
        var e = document.getElementById('stat11').value;
        var e2 = document.getElementById('stat22').value;
        var e3 = document.getElementById('stat33').value;
    ...
    if ($("#traffic-chart").length) {
      ...
      var gradientLegendGreen = 'linear-gradient(to right, rgba(6, 185, 157, 1), rgba(132, 217, 210, 1))';
        var element = document.getElementById('stat1').value;
        var element2 = document.getElementById('stat2').value;
        var element3 = document.getElementById('stat3').value;

      var trafficChartData = {
        datasets: [{
          data: [element,element2,element3 ],
          backgroundColor: [
            gradientStrokeBlue,
            gradientStrokeGreen,
            gradientStrokeRed
